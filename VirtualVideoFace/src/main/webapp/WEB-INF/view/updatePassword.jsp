...
<div class = "container">
	<div class="wrapper">
  <spring:form action="passwordUpdate" modelAttribute="employee" method="POST">
  <h3 class="form-signin-heading">Update Password</h3>
    <hr class="colorgraph"><br>
     ...
     <div class="form-group">
      ...
      <spring:input type="password" class="form-control" id="confrimPassword" placeholder="Enter confrim Password" path="confrimPassword"/>
